...
#include "../../../../../../DSVisual-master/scene.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSceneENDCLASS_t qt_meta_stringdata_CLASSSceneENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(6, 23),  // "BinTreeNodeCountChanged"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 9),  // "nodeCount"
        QT_MOC_LITERAL(41, 9),  // "treeDepth"
        QT_MOC_LITERAL(51, 17)   // "AnimationFinished"
    },
    "Scene",
    "BinTreeNodeCountChanged",
    "",
...
Q_CONSTINIT const QMetaObject Scene::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSceneENDCLASS_t,
        ...
        // method 'BinTreeNodeCountChanged'
...
void Scene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->BinTreeNodeCountChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Scene::BinTreeNodeCountChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Scene::*)();
            if (_t _q_method = &Scene::AnimationFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Scene::BinTreeNodeCountChanged(int _t1, int _t2)
{
